...
2. *shallowHRD* can be adapted to other software outputs <br/> 
[QDNAseq](https://github.com/ccagc/QDNAseq) for instance <br/>
(just comment the two lines of  after "No log2 transformation" in the sub-section "Fast-gathering" of shallowHRD.R - 10/17/2019) <br/>
